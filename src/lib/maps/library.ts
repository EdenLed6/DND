...
const CATS: { cat: MapCategory; label: string; sizes: [number, number][]; icon: string }[] = [
  { cat: "dungeon", label: "מבוך", icon: "🏰", sizes: [[16, 12], [20, 14], [24, 18], [12, 10]] },
  { cat: "cave", label: "מערה", icon: "🕳", sizes: [[18, 14], [22, 16], [14, 12]] },
  { cat: "tavern", label: "טברנה", icon: "🍺", sizes: [[16, 12], [20, 14], [12, 10]] },
  { cat: "forest", label: "יער", icon: "🌲", sizes: [[20, 16], [24, 18], [16, 14]] },
  { cat: "crypt", label: "קריפטה", icon: "⚰", sizes: [[16, 14], [20, 16]] },
  { cat: "ruins", label: "חורבות", icon: "🏛", sizes: [[20, 16], [24, 18], [16, 12]] },
  { cat: "sewer", label: "ביוב", icon: "🌊", sizes: [[16, 14], [20, 16]] },
  { cat: "grid", label: "רשת ריקה", icon: "▦", sizes: [[20, 14], [30, 20], [12, 10]] },
];
