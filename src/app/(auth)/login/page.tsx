      ...
      <div className="card w-full max-w-md">
        ...
        {googleEnabled && (
          <>
            ...
            <div className="mb-3 flex items-center gap-2 text-xs text-[#7d6f5c]">
              <div className="h-px flex-1 bg-[#2a2119]" /> or <div className="h-px flex-1 bg-[#2a2119]" />
            </div>
          </>
        )}
        ...
        <form onSubmit={submit} className="space-y-3">
          ...
          <div>
            <div className="flex items-center justify-between">
              ...
              {mode === "login" && <Link href="/forgot" className="mb-1 text-xs text-[#a9977c] hover:text-gold">Forgot password?</Link>}
            </div>
            ...
            {mode === "register" && <p className="mt-1 text-xs text-[#7d6f5c]">At least 8 characters.</p>}
          </div>
